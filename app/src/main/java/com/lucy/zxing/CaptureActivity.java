...
import com.lucy.zxing.camera.CameraManager;
import com.lucy.zxing.decode.DecodeThread;
import com.lucy.zxing.utils.BeepManager;
import com.lucy.zxing.utils.CaptureActivityHandler;
import com.lucy.zxing.utils.InactivityTimer;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback, OnClickListener {
	...
	private TextView scanCancel;// 取消扫描
	private ImageButton btnLight;// 灯光开关
	private TextView textLight;// 灯光开关
	...
	public void restartPreviewAfterDelay(long delayMS) {
		if (handler != null) {
			handler.sendEmptyMessageDelayed(Constant.RESTART_PREVIEW, delayMS);
		}
	}
