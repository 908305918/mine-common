...
public final class StateButton extends TextView {
    ...
    public StateButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        float pressedRatio = a.getFloat(R.styleable.StateButton_btnPressedRatio, 0.80f);
        int cornerRadius = a.getLayoutDimension(R.styleable.StateButton_btnCornerRadius, 0);

        ColorStateList solidColor = a.getColorStateList(R.styleable.StateButton_btnSolidColor);
        int strokeColor = a.getColor(R.styleable.StateButton_btnStrokeColor, 0x0);
        int strokeWidth = a.getDimensionPixelSize(R.styleable.StateButton_btnStrokeWidth, 0);
        int strokeDashWidth = a.getDimensionPixelSize(R.styleable.StateButton_btnStrokeDashWidth, 0);
        int strokeDashGap = a.getDimensionPixelSize(R.styleable.StateButton_btnStrokeDashGap, 0);
